package com.example.chat.model.Storage.SQlite;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private final ArrayList<MyNotes> wishList = new ArrayList<>();
    ...
    public void addWishes(MyNotes wish) {
    ...
    //Get all wishes
    public ArrayList<MyNotes> getWishes() {
